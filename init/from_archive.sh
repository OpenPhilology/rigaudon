...
if [ $# -eq 1 ] ; then
	...
	export DICTIONARY_FILE=/home/fbaumgardt/ocr/bin/rigaudon/dicts/MORPHEUS_DUMP_PLUS-greek-dictionary-with-bogus-freq.txt
	...
	echo "Usage: init/from_archive.sh <name_of_archive>"
